## drknz pro coder ong finna do a jays classic
...
os.system(f'cls & mode 85,20 & title [Limbz Nuker] - Configuration')
...
def updateCheck():
    ...
    if version in r.text:
        ...
        print(f"\x1b[38;5;56m[\033[37m!\x1b[38;5;56m] \033[37mNew Update Available. Download From: \x1b[38;5;56mgithub.com/skidskys\033[37m")
        os.system('start https://github.com/skeqt/LimbzNuker/releases')
        input()
        os._exit(0)
...
def RichPresence():
    if rich_presence == "y" or rich_presence == "Y":
        try:
            ...
            RPC.connect() 
            RPC.update(details="Connected", large_image="Limbzlarge2", small_image="Limbz", large_text="github.com/skeqt/LimbzNuker", start=time.time())
        except:
            pass
...
class Limbz:
    ...
    async def ThemeChanger(self):
        os.system(f'cls & mode 85,20 & title [Limbz Nuker] - Themes')
        print(f'''
                          {self.colour}Limbz Nuker
      {self.colour}╔═══════════════════════╦═══════════════════════╦═══════════════════════╗\033[37m
    ...
    async def Menu(self):
        os.system(f'cls & mode 85,20 & title [Limbz Nuker] - Connected: {client.user}')
        print(f'''
                          {self.colour}Limbz Nuker
      {self.colour}╔═══════════════════════╦═══════════════════════╦═══════════════════════╗\033[37m
...
if __name__ == "__main__":
    ...
    loop.create_task(Limbz().DebuggerCheck())
    Limbz().Startup()
